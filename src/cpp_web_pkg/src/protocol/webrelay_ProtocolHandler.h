...
public:
	...
	virtual bool ReqFindInstance(webrelay::ReqFindInstance_Packet &packet) { return true; }
...
public:
	...
	virtual bool AckFindInstance(webrelay::AckFindInstance_Packet &packet) { return true; }
	virtual bool AckPing(webrelay::AckPing_Packet &packet) { return true; }
	virtual bool InstanceInfo(webrelay::InstanceInfo_Packet &packet) { return true; }
};
